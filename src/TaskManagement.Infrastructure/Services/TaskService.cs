...
namespace TaskManagementSystem.Infrastructure.Services
{
    public class TaskService : ITaskService
    {
        ...
        public async Task<PagedResponse<TaskResponseDto>> GetTasksAsync(Guid userId,string role,bool? isCompleted,PaginationParams pagination)
        {
            // 🔹 Start query
            var query = _context.Tasks.AsNoTracking();

            //  ADD THIS ROLE CHECK HERE
            ...
            // 🔹 Mapping
            var data = _mapper.Map<List<TaskResponseDto>>(tasks);
